...
enum class CategoryType(@StringRes val title: Int, val query: String) {
    ...
    WOMENS_DRESSES(R.string.category_label__womens_dresses, "womens-dresses"),
    WOMENS_SHOES(R.string.category_label__womens_shoes, "womens-shoes"),
    MENS_SHIRTS(R.string.category_label__mens_shirts, "mens-shirts"),
    MENS_SHOES(R.string.category_label__mens_shoes, "mens-shoes"),
    MENS_WATCHES(R.string.category_label__mens_watches, "mens-watches"),
    WOMENS_WATCHES(R.string.category_label__womens_watches, "womens-watches"),
    WOMENS_BAGS(R.string.category_label__womens_bags, "womens-bags"),
    WOMENS_JEWELLERY(R.string.category_label__womens_jewellery, "womens-jewellery"),
